  ...
  return (
    <div className="min-h-screen bg-screenBg">
      <div className="max-w-4xl mx-auto px-3 sm:px-5 lg:px-6 py-4">
        {/* Header */}
        <div className="mb-4">
          <h1 className="text-lg font-bold text-textDark">Create Admin Account</h1>
          <p className="mt-0.5 text-2xs text-textLight">Add a new admin to the ISKCON community</p>
        </div>
