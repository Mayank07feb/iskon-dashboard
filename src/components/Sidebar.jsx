...
import {
  ...
  PlusCircleIcon,
  Cog6ToothIcon,
  FolderIcon, // optional icon for Categories
...
export default function Sidebar({ sidebarOpen, setSidebarOpen, logout }) {
  ...
  const menuItems = [
    ...
    { label: "Categories", path: "/categories", icon: <FolderIcon className="w-5 h-5" /> }, // ✅ Added Categories page
      ...
      >
        ...
        <div className="px-4 py-4 border-b flex justify-between items-center bg-white">
          <div className="flex items-center gap-2">
            ...
            <span className="text-md font-bold text-primary">ISKCON DASHBOARD</span>
          </div>
          <button className="md:hidden text-textDark hover:text-primaryHover transition" onClick={() => setSidebarOpen(false)}>
